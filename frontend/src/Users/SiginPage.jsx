...
const SiginPage = () => {
  const handleTestSignIn = () => {
    fetch(
      "https://super-market-software-git-main-rajeshjoesphs-projects.vercel.app/signin",
      {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          email: "rajeshkannan1999.rk@gmail.com",
          password: "rajeshkannan",
        }),
      }
    )
  ...
  return (
    <div>
      <button onClick={handleTestSignIn} className="test-button">
        Test Sign In with Fetch
      </button>
    </div>
  );
};
